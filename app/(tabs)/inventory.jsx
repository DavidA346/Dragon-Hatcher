...
const styles = StyleSheet.create({
    ...
    card: { borderRadius: 20, margin: 8, width: 120, alignItems: 'center', justifyContent: 'center', paddingRight: 10 },
    image: { width: 100, height: 100, marginLeft: '25%' },
    stats: { fontWeight: 'bold', textDecorationLine: 'underline', fontSize: 18, justifyContent: 'center' },
    ...
    goldContainer: { flexDirection: 'row', alignItems: 'center', height: '3%', marginLeft: '46%', marginRight: '42%' },
    goldText: { fontSize: 27, fontWeight: 'bold', color: 'black' },
    gold_coin: { width: '100%', height: '100%', resizeMode: 'contain' },
    plusOneContainer: { position: 'absolute', top: '35%', left: '20%', flexDirection: 'row', alignItems: 'center' },
